...
describe('cli', () => {
  ...
  it('deberia de retornar un string con dos datos', () => cli(arg1).then(response => expect(response).toEqual('Total:4\nunique:1')));
  it('deberia de retornar un string con dos datos', () => cli(arg2).then(response => expect(response).toEqual(
    `${path.resolve(`${process.cwd()}/test/prueba/prueba1/documento4.md`)} https://nodejs.org/en/ hola 200 OK`)));
  it('deberia de retornar un string con dos datos', () => cli(arg3).then(response => expect(response).toEqual('Total:4\nunique:1\nBroken:3')));
  it('deberia de retornar un string con dos datos', () => cli(arg4).then(response => expect(response).toEqual(
